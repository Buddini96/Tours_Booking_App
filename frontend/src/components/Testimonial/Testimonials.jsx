    ...
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        <p>
          ...
          accusantium. Doloribus veniam ab nam aut distinctio necessitatibus
          quaerat nesciunt quidem molestiae laborum, delectus earum quas cum
          obcaecati et aspernatur dolores.
        </p>
